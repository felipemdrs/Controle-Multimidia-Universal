...
public class SearchResidence extends AsyncTask<Void, Integer, String> {
	...
	public SearchResidence(Context activityContextApplication) {
	...
	private String searchAddress(String address) {
		try {
			...
			address = HttpSenderTask.createURL(param);
					...
					.setPositiveButton(
							...
							new DialogInterface.OnClickListener() {
								public void onClick(DialogInterface dialog,
									...
									builder.create();
									onCancelled();
									new SearchResidence(mContext).execute();
								}
							})
					.setNegativeButton(
